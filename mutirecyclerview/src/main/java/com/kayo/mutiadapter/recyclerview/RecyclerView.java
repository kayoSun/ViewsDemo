...
//
//    static final String TAG = "com.kayo.mutiadapter.recyclerview.RecyclerView";
//
...
//     * this value might be garbage. To save LayoutManagers from it, com.kayo.mutiadapter.recyclerview.RecyclerView sets the size to
...
//     * that the com.kayo.mutiadapter.recyclerview.RecyclerView should use the standard touch slop for smooth,
...
//    /**
//     * Constant for use with {@link #setScrollingTouchSlop(int)}. Indicates
//     * that the com.kayo.mutiadapter.recyclerview.RecyclerView should use the standard touch slop for scrolling
...
//
//    /**
//     * com.kayo.mutiadapter.recyclerview.RecyclerView is calculating a scroll.
//     * If there are too many of these in Systrace, some Views inside com.kayo.mutiadapter.recyclerview.RecyclerView might be causing
...
//     * If this shows up too many times in Systrace, make sure the children of com.kayo.mutiadapter.recyclerview.RecyclerView do not
//     * update themselves directly. This will cause a full re-layout but when it happens via the
//     * Adapter notifyItemChanged, com.kayo.mutiadapter.recyclerview.RecyclerView can avoid full layout calculation.
//     */
...
//
//    /**
//     * com.kayo.mutiadapter.recyclerview.RecyclerView is doing a layout for partial adapter updates (we know what has changed)
...
//
//    /**
//     * com.kayo.mutiadapter.recyclerview.RecyclerView is rebinding a View.
...
//
//    /**
//     * com.kayo.mutiadapter.recyclerview.RecyclerView is attempting to pre-populate off screen views.
//     */
//    private static final String TRACE_PREFETCH_TAG = "RV Prefetch";
//
//    /**
//     * com.kayo.mutiadapter.recyclerview.RecyclerView is creating a new View.
...
//
//    /**
//     * Handles abstraction between LayoutManager children and com.kayo.mutiadapter.recyclerview.RecyclerView children
//     */
...
//
//    /**
//     * The com.kayo.mutiadapter.recyclerview.RecyclerView is not currently scrolling.
//     * @see #getScrollState()
//     */
//    public static final int SCROLL_STATE_IDLE = 0;
//
//    /**
//     * The com.kayo.mutiadapter.recyclerview.RecyclerView is currently being dragged by outside input such as user touch input.
//     * @see #getScrollState()
//     */
//    public static final int SCROLL_STATE_DRAGGING = 1;
//
//    /**
//     * The com.kayo.mutiadapter.recyclerview.RecyclerView is currently animating to a final position while not under
//     * outside control.
//     * @see #getScrollState()
//     */
...
//
//    /**
//     * Returns the accessibility delegate compatibility implementation used by the com.kayo.mutiadapter.recyclerview.RecyclerView.
//     * @return An instance of AccessibilityDelegateCompat used by com.kayo.mutiadapter.recyclerview.RecyclerView
//     */
...
//
//    /**
//     * Sets the accessibility delegate compatibility implementation used by com.kayo.mutiadapter.recyclerview.RecyclerView.
//     * @param accessibilityDelegate The accessibility delegate to be used by com.kayo.mutiadapter.recyclerview.RecyclerView.
//     */
...
//
//    /**
//     * com.kayo.mutiadapter.recyclerview.RecyclerView can perform several optimizations if it can know in advance that com.kayo.mutiadapter.recyclerview.RecyclerView's
//     * size is not affected by the adapter contents. com.kayo.mutiadapter.recyclerview.RecyclerView can still change its size based
//     * on other factors (e.g. its parent's size) but this size calculation cannot depend on the
//     * size of its children or contents of its adapter (except the number of items in the adapter).
//     * <p>
//     * If your use of com.kayo.mutiadapter.recyclerview.RecyclerView falls into this category, set this to {@code true}. It will allow
//     * com.kayo.mutiadapter.recyclerview.RecyclerView to avoid invalidating the whole layout when its adapter contents change.
//     *
//     * @param hasFixedSize true if adapter changes cannot affect the size of the com.kayo.mutiadapter.recyclerview.RecyclerView.
//     */
...
//     * the size of the com.kayo.mutiadapter.recyclerview.RecyclerView itself.
//     */
...
//
//    /**
//     * Returns whether this com.kayo.mutiadapter.recyclerview.RecyclerView will clip its children to its padding, and resize (but
//     * not clip) any EdgeEffect to the padded region, if padding is present.
//     * <p>
//     * By default, children are clipped to the padding of their parent
//     * com.kayo.mutiadapter.recyclerview.RecyclerView. This clipping behavior is only enabled if padding is non-zero.
//     *
//     * @return true if this com.kayo.mutiadapter.recyclerview.RecyclerView clips children to its padding and resizes (but doesn't
...
//     *
//     * Set up the com.kayo.mutiadapter.recyclerview.RecyclerView's scrolling motion threshold based on common usages.
...
//     *                     the intended usage of this com.kayo.mutiadapter.recyclerview.RecyclerView
//     */
...
//     * @param removeAndRecycleExistingViews If set to true, com.kayo.mutiadapter.recyclerview.RecyclerView will recycle all existing
...
//     *
//     * <p>This listener will be called when a LayoutManager or the com.kayo.mutiadapter.recyclerview.RecyclerView decides
...
//
//    /**
//     * <p>Return the offset of the com.kayo.mutiadapter.recyclerview.RecyclerView's text baseline from the its top
//     * boundary. If the LayoutManager of this com.kayo.mutiadapter.recyclerview.RecyclerView does not support baseline alignment,
//     * this method returns -1.</p>
//     *
//     * @return the offset of the baseline within the com.kayo.mutiadapter.recyclerview.RecyclerView's bounds or -1
...
//     * from com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
//     * <p>This listener will be called when a LayoutManager or the com.kayo.mutiadapter.recyclerview.RecyclerView decides
//     * that a child view is no longer needed. If an application associates expensive
//     * or heavyweight data with item views, this may be a good place to release
...
//
//    /**
//     * Set the {@link LayoutManager} that this com.kayo.mutiadapter.recyclerview.RecyclerView will use.
//     *
//     * <p>In contrast to other adapter-backed views such as {@link android.widget.ListView}
//     * or {@link android.widget.GridView}, com.kayo.mutiadapter.recyclerview.RecyclerView allows client code to provide custom
//     * layout arrangements for child views. These arrangements are controlled by the
//     * {@link LayoutManager}. A LayoutManager must be provided for com.kayo.mutiadapter.recyclerview.RecyclerView to function.</p>
//     *
...
//                        " is already attached to a com.kayo.mutiadapter.recyclerview.RecyclerView: " + layout.mRecyclerView);
//            }
...
//     * part of the child list of the com.kayo.mutiadapter.recyclerview.RecyclerView, but they are invisible to the LayoutManager
...
//     * layout policy for this com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
...
//
//    /**
//     * Retrieve this com.kayo.mutiadapter.recyclerview.RecyclerView's {@link RecycledViewPool}. This method will never return null;
...
//
//    /**
//     * Return the current scrolling state of the com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
...
//
//    /**
//     * Add an {@link ItemDecoration} to this com.kayo.mutiadapter.recyclerview.RecyclerView. Item decorations can
...
//
//    /**
//     * Remove an {@link ItemDecoration} from this com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
...
//     *
//     * com.kayo.mutiadapter.recyclerview.RecyclerView does not implement scrolling logic, rather forwards the call to
...
//        Log.w(TAG, "com.kayo.mutiadapter.recyclerview.RecyclerView does not support scrolling to an absolute position. "
...
//     * (com.kayo.mutiadapter.recyclerview.RecyclerView.State)
//     */
//    @Override
...
//     * child views are not updated when com.kayo.mutiadapter.recyclerview.RecyclerView is frozen, {@link #smoothScrollBy(int, int)},
...
//
//    /**
//     * Returns the maximum fling velocity used by this com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
//     * @return The maximum fling velocity used by this com.kayo.mutiadapter.recyclerview.RecyclerView.
//     */
...
//
//    /**
//     * Since com.kayo.mutiadapter.recyclerview.RecyclerView is a collection ViewGroup that includes virtual children (items that are
...
//     * <p>
//     * It first does a focus search within the com.kayo.mutiadapter.recyclerview.RecyclerView. If this search finds a View that is in
//     * the focus direction with respect to the currently focused View, com.kayo.mutiadapter.recyclerview.RecyclerView returns that
...
//     * com.kayo.mutiadapter.recyclerview.RecyclerView will call parent to handle the focus search like a regular ViewGroup.
//     * <p>
...
//     * com.kayo.mutiadapter.recyclerview.RecyclerView converts the focus direction to an absolute direction and makes a preliminary
...
//     * focus search with the original (relative) direction. This allows com.kayo.mutiadapter.recyclerview.RecyclerView to provide
//     * better candidates to the focus search while still allowing the view system to take focus from
//     * the com.kayo.mutiadapter.recyclerview.RecyclerView and give it to a more suitable child if such child exists.
//     *
...
//
//    /**
//     * Checks if the new focus candidate is a good enough candidate such that com.kayo.mutiadapter.recyclerview.RecyclerView will
...
//     * and is not the com.kayo.mutiadapter.recyclerview.RecyclerView itself.
//     * When this method returns false, com.kayo.mutiadapter.recyclerview.RecyclerView will let the parent make the decision so the
...
//
//    /**
//     * Returns true if com.kayo.mutiadapter.recyclerview.RecyclerView is attached to window.
//     */
//    // @override
...
//
//    /**
//     * Checks if com.kayo.mutiadapter.recyclerview.RecyclerView is in the middle of a layout or scroll and throws an
...
//        if (!isComputingLayout()) {
//            if (message == null) {
//                throw new IllegalStateException("Cannot call this method unless com.kayo.mutiadapter.recyclerview.RecyclerView is "
...
//        if (isComputingLayout()) {
//            if (message == null) {
//                throw new IllegalStateException("Cannot call this method while com.kayo.mutiadapter.recyclerview.RecyclerView is "
//                        + "computing a layout or scrolling");
//            }
//            throw new IllegalStateException(message);
//        }
...
//                            + " during a measure & layout pass where you cannot change the com.kayo.mutiadapter.recyclerview.RecyclerView"
//                            + " data. Any method call that might change the structure of the com.kayo.mutiadapter.recyclerview.RecyclerView"
...
//
//            // if com.kayo.mutiadapter.recyclerview.RecyclerView has non-exact width and height and if there is at least one child
...
//     * to the items in this com.kayo.mutiadapter.recyclerview.RecyclerView. By default, com.kayo.mutiadapter.recyclerview.RecyclerView instantiates and
//     * uses an instance of {@link DefaultItemAnimator}. Whether item animations are
//     * enabled for the com.kayo.mutiadapter.recyclerview.RecyclerView depends on the ItemAnimator and whether
//     * the LayoutManager {@link LayoutManager#supportsPredictiveItemAnimations()
//     * supports item animations}.
//     *
//     * @param animator The ItemAnimator being set. If null, no animations will occur
//     * when changes occur to the items in this com.kayo.mutiadapter.recyclerview.RecyclerView.
//     */
...
//
//    /**
//     * Returns whether com.kayo.mutiadapter.recyclerview.RecyclerView is currently computing a layout.
//     * <p>
//     * If this method returns true, it means that com.kayo.mutiadapter.recyclerview.RecyclerView is in a lockdown state and any
//     * attempt to update adapter contents will result in an exception because adapter contents
//     * cannot be changed while com.kayo.mutiadapter.recyclerview.RecyclerView is trying to compute the layout.
//     * <p>
//     * It is very unlikely that your code will be running during this state as it is
//     * called by the framework when a layout traversal happens or com.kayo.mutiadapter.recyclerview.RecyclerView starts to scroll
...
//     * similar mechanism.
//     *
//     * @return <code>true</code> if com.kayo.mutiadapter.recyclerview.RecyclerView is currently computing a layout, <code>false</code>
//     *         otherwise
//     */
...
//     * accessibility request arrives while com.kayo.mutiadapter.recyclerview.RecyclerView does not have a stable state which is very
...
//
//    /**
//     * Gets the current ItemAnimator for this com.kayo.mutiadapter.recyclerview.RecyclerView. A null return value
//     * indicates that there is no animator and that item changes will happen without
//     * any animations. By default, com.kayo.mutiadapter.recyclerview.RecyclerView instantiates and
...
//        // Invalidate com.kayo.mutiadapter.recyclerview.RecyclerView to re-draw decorators. This is still efficient because children's
...
//        if (mLayout == null) {
//            throw new IllegalStateException("com.kayo.mutiadapter.recyclerview.RecyclerView has no LayoutManager");
//        }
...
//
//    /**
//     * Returns true if com.kayo.mutiadapter.recyclerview.RecyclerView is currently running some animations.
//     * <p>
...
//
//    /**
//     * Invalidates all ItemDecorations. If com.kayo.mutiadapter.recyclerview.RecyclerView has item decorations, calling this method
...
//
//    /**
//     * Returns true if the com.kayo.mutiadapter.recyclerview.RecyclerView should attempt to preserve currently focused Adapter Item's
//     * focus even if the View representing the Item is replaced during a layout calculation.
//     * <p>
//     * By default, this value is {@code true}.
//     *
//     * @return True if the com.kayo.mutiadapter.recyclerview.RecyclerView will try to preserve focused Item after a layout if it loses
//     * focus.
//     *
...
//
//    /**
//     * Set whether the com.kayo.mutiadapter.recyclerview.RecyclerView should try to keep the same Item focused after a layout
//     * calculation or not.
//     * <p>
...
//     * with another view due to type change or animation. In these cases, com.kayo.mutiadapter.recyclerview.RecyclerView can request
//     * focus on the new view automatically.
//     *
//     * @param preserveFocusAfterLayout Whether com.kayo.mutiadapter.recyclerview.RecyclerView should preserve focused Item during a
...
//     *
//     * @param child Child of this com.kayo.mutiadapter.recyclerview.RecyclerView to query for its ViewHolder
...
//     * also a direct child of the com.kayo.mutiadapter.recyclerview.RecyclerView. This returned view can be used to get the
//     * ViewHolder by calling {@link #getChildViewHolder(View)}.
//     *
//     * @param view The view that is a descendant of the com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
//     * @return The direct child of the com.kayo.mutiadapter.recyclerview.RecyclerView which contains the given view or null if the
//     * provided view is not a descendant of this com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
...
//     * descendant of this com.kayo.mutiadapter.recyclerview.RecyclerView.
//     */
//    @Nullable
...
//     * layout pass.
//     * <p>
//     * This method checks only the children of com.kayo.mutiadapter.recyclerview.RecyclerView. If the item at the given
...
//
//    /**
//     * Return the ViewHolder for the item with the given id. The com.kayo.mutiadapter.recyclerview.RecyclerView must
//     * use an Adapter with {@link Adapter#setHasStableIds(boolean) stableIds} to
//     * return a non-null value.
//     * <p>
//     * This method checks only the children of com.kayo.mutiadapter.recyclerview.RecyclerView. If the item with the given
...
//
//    /**
//     * Called when an item view is attached to this com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
//     * <p>Subclasses of com.kayo.mutiadapter.recyclerview.RecyclerView may want to perform extra bookkeeping or modifications
...
//     * changes.</p>
//     *
//     * @param child Child view that is now attached to this com.kayo.mutiadapter.recyclerview.RecyclerView and its associated window
//     */
//    public void onChildAttachedToWindow(View child) {
//    }
//
//    /**
//     * Called when an item view is detached from this com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
//     * <p>Subclasses of com.kayo.mutiadapter.recyclerview.RecyclerView may want to perform extra bookkeeping or modifications
...
//     *
//     * @param child Child view that is now detached from this com.kayo.mutiadapter.recyclerview.RecyclerView and its associated window
//     */
...
//
//    /**
//     * Called when the scroll position of this com.kayo.mutiadapter.recyclerview.RecyclerView changes. Subclasses should use
...
//     * scroll coordinates. Since com.kayo.mutiadapter.recyclerview.RecyclerView cannot compute the absolute scroll position from
...
//
//        // Pass the real deltas to onScrolled, the com.kayo.mutiadapter.recyclerview.RecyclerView-specific method.
...
//
//    /**
//     * Called when the scroll state of this com.kayo.mutiadapter.recyclerview.RecyclerView changes. Subclasses should use this
...
//        // a consistent state before the com.kayo.mutiadapter.recyclerview.RecyclerView subclass responds.
//        if (mLayout != null) {
//            mLayout.onScrollStateChanged(state);
//        }
//
//        // Let the com.kayo.mutiadapter.recyclerview.RecyclerView subclass handle this event next; any LayoutManager property
...
//     * <p>
//     * This method returns true if com.kayo.mutiadapter.recyclerview.RecyclerView has not yet calculated the first layout after it is
...
//     * <p>
//     * com.kayo.mutiadapter.recyclerview.RecyclerView automatically creates a pool for itself if you don't provide one.
//     *
//     */
...
//     *
//     * <p>A "scrapped" view is a view that is still attached to its parent com.kayo.mutiadapter.recyclerview.RecyclerView but
...
//         * and let the com.kayo.mutiadapter.recyclerview.RecyclerView handle caching. This is a helper method for LayoutManager who
...
//
//        /**
//         * com.kayo.mutiadapter.recyclerview.RecyclerView provides artificial position range (item count) in pre-layout state and
...
//         * case, adapter may choose to recycle it. From com.kayo.mutiadapter.recyclerview.RecyclerView's perspective, the view is
...
//                        + "from com.kayo.mutiadapter.recyclerview.RecyclerView before it can be recycled: " + holder);
//            }
//
//            if (holder.shouldIgnore()) {
...
//         *
//         * <p>"Scrap" views are still attached to their parent com.kayo.mutiadapter.recyclerview.RecyclerView but are eligible
...
//         * <p>
//         * com.kayo.mutiadapter.recyclerview.RecyclerView will re-bind the returned View to the position if necessary.
//         *
...
//
//        /**
//         * Called when com.kayo.mutiadapter.recyclerview.RecyclerView needs a new {@link ViewHolder} of the given type to represent
//         * an item.
//         * <p>
...
//
//        /**
//         * Called by com.kayo.mutiadapter.recyclerview.RecyclerView to display the data at the specified position. This method should
//         * update the contents of the {@link ViewHolder#itemView} to reflect the item at the given
//         * position.
//         * <p>
//         * Note that unlike {@link android.widget.ListView}, com.kayo.mutiadapter.recyclerview.RecyclerView will not call this method
...
//
//        /**
//         * Called by com.kayo.mutiadapter.recyclerview.RecyclerView to display the data at the specified position. This method
...
//         * {@link ViewHolder} and initializes some private fields to be used by com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
...
//         * private fields to be used by com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
//         * @see #onBindViewHolder(ViewHolder, int)
//         */
...
//         * attached to the parent com.kayo.mutiadapter.recyclerview.RecyclerView. If an item view has large or expensive data
//         * bound to it such as large bitmaps, this may be a good place to release those
//         * resources.</p>
//         * <p>
//         * com.kayo.mutiadapter.recyclerview.RecyclerView calls this method right before clearing ViewHolder's internal data and
...
//
//        /**
//         * Called by the com.kayo.mutiadapter.recyclerview.RecyclerView if a ViewHolder created by this Adapter cannot be recycled
//         * due to its transient state. Upon receiving this callback, Adapter can clear the
//         * animation(s) that effect the View's transient state and return <code>true</code> so that
//         * the View can be recycled. Keep in mind that the View in question is already removed from
//         * the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * <p>
//         * In some cases, it is acceptable to recycle a View although it has transient state. Most
//         * of the time, this is a case where the transient state will be cleared in
//         * {@link #onBindViewHolder(ViewHolder, int)} call when View is rebound to a new position.
//         * For this reason, com.kayo.mutiadapter.recyclerview.RecyclerView leaves the decision to the Adapter and uses the return
//         * value of this method to decide whether the View should be recycled or not.
//         * <p>
//         * Note that when all animations are created by {@link RecyclerView.ItemAnimator}, you
//         * should never receive this callback because com.kayo.mutiadapter.recyclerview.RecyclerView keeps those Views as children
...
//         * returns <code>true</code>, com.kayo.mutiadapter.recyclerview.RecyclerView <em>will ignore</em> the transient state of
//         * the View and recycle it regardless. If this method returns <code>false</code>,
//         * com.kayo.mutiadapter.recyclerview.RecyclerView will check the View's transient state again before giving a final decision.
...
//
//        /**
//         * Called by com.kayo.mutiadapter.recyclerview.RecyclerView when it starts observing this Adapter.
//         * <p>
//         * Keep in mind that same adapter may be observed by multiple RecyclerViews.
//         *
//         * @param recyclerView The com.kayo.mutiadapter.recyclerview.RecyclerView instance which started observing this adapter.
...
//
//        /**
//         * Called by com.kayo.mutiadapter.recyclerview.RecyclerView when it stops observing this Adapter.
//         *
//         * @param recyclerView The com.kayo.mutiadapter.recyclerview.RecyclerView instance which stopped observing this adapter.
...
//         *
//         * <p><code>com.kayo.mutiadapter.recyclerview.RecyclerView</code> will attempt to synthesize visible structural change events
...
//     * within a <code>com.kayo.mutiadapter.recyclerview.RecyclerView</code> as well as determining the policy for when to recycle
//     * item views that are no longer visible to the user. By changing the <code>LayoutManager</code>
//     * a <code>com.kayo.mutiadapter.recyclerview.RecyclerView</code> can be used to implement a standard vertically scrolling list,
//     * a uniform grid, staggered grids, horizontally scrolling collections and more. Several stock
//     * layout managers are provided for general use.
//     * <p/>
//     * If the LayoutManager specifies a default constructor or one with the signature
//     * ({@link Context}, {@link AttributeSet}, {@code int}, {@code int}), com.kayo.mutiadapter.recyclerview.RecyclerView will
...
//
//        /**
//         * These measure specs might be the measure specs that were passed into com.kayo.mutiadapter.recyclerview.RecyclerView's
//         * onMeasure method OR fake measure specs created by the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * For example, when a layout is run, com.kayo.mutiadapter.recyclerview.RecyclerView always sets these specs to be
//         * EXACTLY because a LayoutManager cannot resize com.kayo.mutiadapter.recyclerview.RecyclerView during a layout pass.
//         * <p>
//         * Also, to be able to use the hint in unspecified measure specs, com.kayo.mutiadapter.recyclerview.RecyclerView checks the
...
//         *
//         * @param widthSpec The widthSpec that was passing into com.kayo.mutiadapter.recyclerview.RecyclerView's onMeasure
//         * @param heightSpec The heightSpec that was passing into com.kayo.mutiadapter.recyclerview.RecyclerView's onMeasure
//         */
...
//         * called after the com.kayo.mutiadapter.recyclerview.RecyclerView calls
...
//         * <p>
//         * The default implementation adds the com.kayo.mutiadapter.recyclerview.RecyclerView's padding to the given bounding box
...
//         * @param wSpec The widthMeasureSpec that was passed into the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * @param hSpec The heightMeasureSpec that was passed into the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
...
//
//        /**
//         * Calls {@code com.kayo.mutiadapter.recyclerview.RecyclerView#requestLayout} on the underlying com.kayo.mutiadapter.recyclerview.RecyclerView
//         */
//        public void requestLayout() {
...
//
//        /**
//         * Defines whether the layout should be measured by the com.kayo.mutiadapter.recyclerview.RecyclerView or the LayoutManager
...
//         * handle various specs provided by the com.kayo.mutiadapter.recyclerview.RecyclerView's parent.
...
//         * capabilities of the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * <p>
...
//         * exact, com.kayo.mutiadapter.recyclerview.RecyclerView will only call LayoutManager's {@code onMeasure} and return without
//         * doing any layout calculation.</li>
//         * <li>If one of the layout specs is not {@code EXACT}, the com.kayo.mutiadapter.recyclerview.RecyclerView will start the
...
//         * return the width and height of the com.kayo.mutiadapter.recyclerview.RecyclerView as of the last layout calculation.
//         * <p>
//         * After handling the predictive case, com.kayo.mutiadapter.recyclerview.RecyclerView will call
...
//         * <li>After the layout calculation, com.kayo.mutiadapter.recyclerview.RecyclerView sets the measured width & height by
//         * calculating the bounding box for the children (+ com.kayo.mutiadapter.recyclerview.RecyclerView's padding). The
...
//         * <li>Any following on measure call to the com.kayo.mutiadapter.recyclerview.RecyclerView will run
//         * {@link #onLayoutChildren(Recycler, State)} with {@link State#isMeasuring()} set to
//         * {@code true} and {@link State#isPreLayout()} set to {@code false}. com.kayo.mutiadapter.recyclerview.RecyclerView will
...
//         * </li>
//         * <li>When measure is complete and com.kayo.mutiadapter.recyclerview.RecyclerView's
//         * {@link #onLayout(boolean, int, int, int, int)} method is called, com.kayo.mutiadapter.recyclerview.RecyclerView checks
...
//         *                             com.kayo.mutiadapter.recyclerview.RecyclerView, <code>false</code> if the LayoutManager wants
//         *                             to measure itself.
//         *
...
//         *
//         * @return <code>True</code> if the LayoutManager is measured by the com.kayo.mutiadapter.recyclerview.RecyclerView or
...
//         *
//         * <p>Whether item animations are enabled in a com.kayo.mutiadapter.recyclerview.RecyclerView is determined both
//         * by the return value from this method and the
//         * {@link RecyclerView#setItemAnimator(ItemAnimator) ItemAnimator} set on the
//         * com.kayo.mutiadapter.recyclerview.RecyclerView itself. If the com.kayo.mutiadapter.recyclerview.RecyclerView has a non-null ItemAnimator but this
...
//         * the com.kayo.mutiadapter.recyclerview.RecyclerView has a non-null ItemAnimator and this method returns true,
...
//
//        /**
//         * Returns whether LayoutManager is currently attached to a com.kayo.mutiadapter.recyclerview.RecyclerView which is attached
//         * to a window.
//         *
//         * @return True if this LayoutManager is controlling a com.kayo.mutiadapter.recyclerview.RecyclerView and the com.kayo.mutiadapter.recyclerview.RecyclerView
...
//         * <p>
//         * Calling this method when LayoutManager is not attached to a com.kayo.mutiadapter.recyclerview.RecyclerView has no effect.
//         *
...
//         *
//         * @return true if com.kayo.mutiadapter.recyclerview.RecyclerView could ask the Handler to remove the Runnable,
...
//        }
//        /**
//         * Called when this LayoutManager is both attached to a com.kayo.mutiadapter.recyclerview.RecyclerView and that com.kayo.mutiadapter.recyclerview.RecyclerView
//         * is attached to a window.
//         * <p>
//         * If the com.kayo.mutiadapter.recyclerview.RecyclerView is re-attached with the same LayoutManager and Adapter, it may not
//         * call {@link #onLayoutChildren(Recycler, State)} if nothing has changed and a layout was
//         * not requested on the com.kayo.mutiadapter.recyclerview.RecyclerView while it was detached.
//         * <p>
//         * Subclass implementations should always call through to the superclass implementation.
//         *
//         * @param view The com.kayo.mutiadapter.recyclerview.RecyclerView this LayoutManager is bound to
//         *
...
//
//        /**
//         * Called when this LayoutManager is detached from its parent com.kayo.mutiadapter.recyclerview.RecyclerView or when
//         * its parent com.kayo.mutiadapter.recyclerview.RecyclerView is detached from its window.
//         * <p>
//         * LayoutManager should clear all of its View references as another LayoutManager might be
//         * assigned to the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * <p>
//         * If the com.kayo.mutiadapter.recyclerview.RecyclerView is re-attached with the same LayoutManager and Adapter, it may not
//         * call {@link #onLayoutChildren(Recycler, State)} if nothing has changed and a layout was
//         * not requested on the com.kayo.mutiadapter.recyclerview.RecyclerView while it was detached.
...
//         * com.kayo.mutiadapter.recyclerview.RecyclerView is re-attached.
//         * <p>
//         * Subclass implementations should always call through to the superclass implementation.
//         *
//         * @param view The com.kayo.mutiadapter.recyclerview.RecyclerView this LayoutManager is bound to
...
//
//        /**
//         * Check if the com.kayo.mutiadapter.recyclerview.RecyclerView is configured to clip child views to its padding.
//         *
//         * @return true if this com.kayo.mutiadapter.recyclerview.RecyclerView clips children to its padding, false otherwise
//         */
//        public boolean getClipToPadding() {
...
//         * com.kayo.mutiadapter.recyclerview.RecyclerView has a non-null {@link #getItemAnimator() ItemAnimator}, and simple
...
//         * com.kayo.mutiadapter.recyclerview.RecyclerView will have enough information to run those animations in a simple
...
//         * appropriately, without regard to the actual bounds of the com.kayo.mutiadapter.recyclerview.RecyclerView. This allows
//         * the animation system to know the location to which to animate these disappearing
//         * views.</p>
//         *
//         * <p>The default LayoutManager implementations for com.kayo.mutiadapter.recyclerview.RecyclerView handle all of these
//         * requirements for animations already. Clients of com.kayo.mutiadapter.recyclerview.RecyclerView can either use one
...
//         *                         position
//         * @param state            Transient state of com.kayo.mutiadapter.recyclerview.RecyclerView
//         */
...
//
//        /**
//         * Create a default <code>LayoutParams</code> object for a child of the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
...
//         * </p>
//         * @param recyclerView The com.kayo.mutiadapter.recyclerview.RecyclerView to which this layout manager is attached
//         * @param state    Current State of com.kayo.mutiadapter.recyclerview.RecyclerView
//         * @param position Scroll to this adapter position.
//         */
...
//
//        /**
//         * Returns the resolved layout direction for this com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
...
//         * visible portion of the container but is being laid out in order to inform com.kayo.mutiadapter.recyclerview.RecyclerView
...
//
//        /**
//         * Add a view to the currently attached com.kayo.mutiadapter.recyclerview.RecyclerView if needed. LayoutManagers should
...
//                }
//                if (currentIndex == -1) {
//                    throw new IllegalStateException("Added View has com.kayo.mutiadapter.recyclerview.RecyclerView as parent but"
...
//
//        /**
//         * Remove a view from the currently attached com.kayo.mutiadapter.recyclerview.RecyclerView if needed. LayoutManagers should
...
//
//        /**
//         * Remove all views from the currently attached com.kayo.mutiadapter.recyclerview.RecyclerView. This will not recycle
...
//
//        /**
//         * Returns offset of the com.kayo.mutiadapter.recyclerview.RecyclerView's text baseline from the its top boundary.
//         *
//         * @return The offset of the com.kayo.mutiadapter.recyclerview.RecyclerView's text baseline from the its top boundary; -1 if
...
//         * <p>
//         * Note that this method may return null if the view is a child of the com.kayo.mutiadapter.recyclerview.RecyclerView but
...
//         * views currently attached to the com.kayo.mutiadapter.recyclerview.RecyclerView. Generally LayoutManager implementations
...
//         * before the LayoutManager entry point method called by com.kayo.mutiadapter.recyclerview.RecyclerView returns.</p>
//         *
...
//
//        /**
//         * Return the current number of child views attached to the parent com.kayo.mutiadapter.recyclerview.RecyclerView.
...
//
//        /**
//         * Return the width measurement spec mode of the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * <p>
//         * This value is set only if the LayoutManager opts into the auto measure api via
//         * {@link #setAutoMeasureEnabled(boolean)}.
//         * <p>
//         * When com.kayo.mutiadapter.recyclerview.RecyclerView is running a layout, this value is always set to
...
//
//        /**
//         * Return the height measurement spec mode of the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * <p>
//         * This value is set only if the LayoutManager opts into the auto measure api via
//         * {@link #setAutoMeasureEnabled(boolean)}.
//         * <p>
...
//
//        /**
//         * Return the width of the parent com.kayo.mutiadapter.recyclerview.RecyclerView
//         *
...
//
//        /**
//         * Return the height of the parent com.kayo.mutiadapter.recyclerview.RecyclerView
//         *
...
//
//        /**
//         * Return the left padding of the parent com.kayo.mutiadapter.recyclerview.RecyclerView
//         *
...
//
//        /**
//         * Return the top padding of the parent com.kayo.mutiadapter.recyclerview.RecyclerView
//         *
//         * @return Padding in pixels
//         */
...
//
//        /**
//         * Return the right padding of the parent com.kayo.mutiadapter.recyclerview.RecyclerView
//         *
//         * @return Padding in pixels
//         */
...
//
//        /**
//         * Return the bottom padding of the parent com.kayo.mutiadapter.recyclerview.RecyclerView
//         *
//         * @return Padding in pixels
//         */
...
//
//        /**
//         * Return the start padding of the parent com.kayo.mutiadapter.recyclerview.RecyclerView
//         *
//         * @return Padding in pixels
//         */
...
//
//        /**
//         * Return the end padding of the parent com.kayo.mutiadapter.recyclerview.RecyclerView
//         *
//         * @return Padding in pixels
//         */
...
//
//        /**
//         * Returns true if the com.kayo.mutiadapter.recyclerview.RecyclerView this LayoutManager is bound to has focus.
//         *
//         * @return True if the com.kayo.mutiadapter.recyclerview.RecyclerView has focus, false otherwise.
//         * @see View#isFocused()
//         */
...
//
//        /**
//         * Returns true if the com.kayo.mutiadapter.recyclerview.RecyclerView this LayoutManager is bound to has or contains focus.
//         *
//         * @return true if the com.kayo.mutiadapter.recyclerview.RecyclerView has or contains focus
//         * @see View#hasFocus()
//         */
...
//         *
//         * @return A direct child of com.kayo.mutiadapter.recyclerview.RecyclerView which has focus or contains the focused child.
//         */
...
//
//        /**
//         * Returns the number of items in the adapter bound to the parent com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * <p>
...
//
//        /**
//         * Offset all child views attached to the parent com.kayo.mutiadapter.recyclerview.RecyclerView by dx pixels along
//         * the horizontal axis.
//         *
...
//
//        /**
//         * Offset all child views attached to the parent com.kayo.mutiadapter.recyclerview.RecyclerView by dy pixels along
//         * the vertical axis.
//         *
...
//         * call remove and invalidate com.kayo.mutiadapter.recyclerview.RecyclerView to ensure UI update.
//         *
...
//         * of the parent com.kayo.mutiadapter.recyclerview.RecyclerView and any added item decorations into account.
//         *
//         * <p>If the com.kayo.mutiadapter.recyclerview.RecyclerView can be scrolled in either dimension the caller may
...
//
//        /**
//         * com.kayo.mutiadapter.recyclerview.RecyclerView internally does its own View measurement caching which should help with
//         * WRAP_CONTENT.
//         * <p>
...
//
//        /**
//         * In addition to the View Framework's measurement cache, com.kayo.mutiadapter.recyclerview.RecyclerView uses its own
...
//
//        /**
//         * Sets whether com.kayo.mutiadapter.recyclerview.RecyclerView should use its own measurement cache for the children. This is
...
//        /**
//         * Measure a child view using standard measurement policy, taking the padding
//         * of the parent com.kayo.mutiadapter.recyclerview.RecyclerView, any added item decorations and the child margins
//         * into account.
//         *
//         * <p>If the com.kayo.mutiadapter.recyclerview.RecyclerView can be scrolled in either dimension the caller may
//         * pass 0 as the widthUsed or heightUsed parameters as they will be irrelevant.</p>
...
//         * @param canScroll true if the parent com.kayo.mutiadapter.recyclerview.RecyclerView can scroll in this dimension
//         *
...
//
//        /**
//         * Lay out the given child view within the com.kayo.mutiadapter.recyclerview.RecyclerView using coordinates that
...
//         * (translation, scale etc) with respect to the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * <p>
...
//         * for the current content of the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
...
//
//        /**
//         * Called when a child of the com.kayo.mutiadapter.recyclerview.RecyclerView wants a particular rectangle to be positioned
...
//         * to bring the given rect into view, within the padded area of the com.kayo.mutiadapter.recyclerview.RecyclerView.</p>
//         *
...
//
//        /**
//         * Called when a descendant view of the com.kayo.mutiadapter.recyclerview.RecyclerView requests focus.
//         *
...
//         *
//         * @param parent  The com.kayo.mutiadapter.recyclerview.RecyclerView hosting this LayoutManager
//         * @param state   Current state of com.kayo.mutiadapter.recyclerview.RecyclerView
//         * @param child   Direct child of the com.kayo.mutiadapter.recyclerview.RecyclerView containing the newly focused view
...
//
//        /**
//         * Called if the com.kayo.mutiadapter.recyclerview.RecyclerView this LayoutManager is bound to has a different adapter set.
...
//
//        /**
//         * Called to populate focusable views within the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
...
//         * suppressed.</p>
//         *
//         * <p>The default implementation returns <code>false</code> to trigger com.kayo.mutiadapter.recyclerview.RecyclerView
//         * to fall back to the default ViewGroup behavior.</p>
//         *
//         * @param recyclerView The com.kayo.mutiadapter.recyclerview.RecyclerView hosting this LayoutManager
...
//         * <p>Default implementation returns 0.</p>
//         *
//         * @param state Current State of com.kayo.mutiadapter.recyclerview.RecyclerView where you can find total item count
//         * @return The horizontal offset of the scrollbar's thumb
...
//
//        /**
//         * Measure the attached com.kayo.mutiadapter.recyclerview.RecyclerView. Implementations must call
...
//         * the minimum width and height properties of the host com.kayo.mutiadapter.recyclerview.RecyclerView if measured
//         * as UNSPECIFIED. AT_MOST measurements will be treated as EXACTLY and the com.kayo.mutiadapter.recyclerview.RecyclerView
...
//         * host com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
...
//
//        /**
//         * @return The host com.kayo.mutiadapter.recyclerview.RecyclerView's {@link View#getMinimumWidth()}
//         */
...
//
//        /**
//         * @return The host com.kayo.mutiadapter.recyclerview.RecyclerView's {@link View#getMinimumHeight()}
//         */
...
//         * <p>com.kayo.mutiadapter.recyclerview.RecyclerView does NOT verify if the LayoutManager has changed between state save and
...
//
//        /**
//         * com.kayo.mutiadapter.recyclerview.RecyclerView calls this method to notify LayoutManager that scroll state has changed.
//         *
//         * @param state The new scroll state for com.kayo.mutiadapter.recyclerview.RecyclerView
//         */
//        public void onScrollStateChanged(int state) {
//        }
//
...
//         *                 positions
//         * @param state    The current state of com.kayo.mutiadapter.recyclerview.RecyclerView
...
//
//        /**
//         * A LayoutManager can call this method to force com.kayo.mutiadapter.recyclerview.RecyclerView to run simple animations in
//         * the next layout pass, even if there is not any trigger to do so. (e.g. adapter data
//         * change).
//         * <p>
//         * Note that, calling this method will not guarantee that com.kayo.mutiadapter.recyclerview.RecyclerView will run animations
//         * at all. For example, if there is not any {@link ItemAnimator} set, com.kayo.mutiadapter.recyclerview.RecyclerView will
...
//
//        /**
//         * Called by AccessibilityDelegate when an action is requested from the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
//         * @param recycler  The Recycler that can be used to convert view positions into adapter
//         *                  positions
//         * @param state     The current state of com.kayo.mutiadapter.recyclerview.RecyclerView
...
//        /**
//         * Draw any appropriate decorations into the Canvas supplied to the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         * Any content drawn by this method will be drawn before the item views are drawn,
//         * and will thus appear underneath the views.
//         *
//         * @param c Canvas to draw into
//         * @param parent com.kayo.mutiadapter.recyclerview.RecyclerView this ItemDecoration is drawing into
//         * @param state The current state of com.kayo.mutiadapter.recyclerview.RecyclerView
//         */
...
//         * @param parent  com.kayo.mutiadapter.recyclerview.RecyclerView this ItemDecoration is decorating
//         * @param state   The current state of com.kayo.mutiadapter.recyclerview.RecyclerView.
//         */
...
//     * view hierarchy level of the com.kayo.mutiadapter.recyclerview.RecyclerView before those touch events are considered for
//     * com.kayo.mutiadapter.recyclerview.RecyclerView's own scrolling behavior.
//     *
//     * <p>This can be useful for applications that wish to implement various forms of gestural
//     * manipulation of item views within the com.kayo.mutiadapter.recyclerview.RecyclerView. OnItemTouchListeners may intercept
//     * a touch interaction already in progress even if the com.kayo.mutiadapter.recyclerview.RecyclerView is already handling that
...
//        /**
//         * Silently observe and/or take over touch events sent to the com.kayo.mutiadapter.recyclerview.RecyclerView
//         * before they are handled by either the com.kayo.mutiadapter.recyclerview.RecyclerView itself or its child views.
//         *
//         * <p>The onInterceptTouchEvent methods of each attached OnItemTouchListener will be run
//         * in the order in which each listener was added, before any other touch processing
//         * by the com.kayo.mutiadapter.recyclerview.RecyclerView itself or child views occurs.</p>
//         *
//         * @param e MotionEvent describing the touch event. All coordinates are in
//         *          the com.kayo.mutiadapter.recyclerview.RecyclerView's coordinate system.
...
//
//        /**
//         * Called when a child of com.kayo.mutiadapter.recyclerview.RecyclerView does not want com.kayo.mutiadapter.recyclerview.RecyclerView and its ancestors to
...
//
//    /**
//     * An OnScrollListener can be added to a com.kayo.mutiadapter.recyclerview.RecyclerView to receive messages when a scrolling event
//     * has occurred on that com.kayo.mutiadapter.recyclerview.RecyclerView.
//     * <p>
...
//        /**
//         * Callback method to be invoked when com.kayo.mutiadapter.recyclerview.RecyclerView's scroll state changes.
//         *
//         * @param recyclerView The com.kayo.mutiadapter.recyclerview.RecyclerView whose scroll state has changed.
...
//
//        /**
//         * Callback method to be invoked when the com.kayo.mutiadapter.recyclerview.RecyclerView has been scrolled. This will be
//         * called after the scroll has completed.
//         * <p>
//         * This callback will also be called if visible item range changes after a layout
//         * calculation. In that case, dx and dy will be 0.
//         *
//         * @param recyclerView The com.kayo.mutiadapter.recyclerview.RecyclerView which scrolled.
...
//
//    /**
//     * A RecyclerListener can be set on a com.kayo.mutiadapter.recyclerview.RecyclerView to receive messages whenever
//     * a view is recycled.
//     *
...
//     * whenever a ViewHolder is attached to or detached from com.kayo.mutiadapter.recyclerview.RecyclerView.
//     */
//    public interface OnChildAttachStateChangeListener {
//
//        /**
//         * Called when a view is attached to the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
//         * @param view The View which is attached to the com.kayo.mutiadapter.recyclerview.RecyclerView
//         */
//        public void onChildViewAttachedToWindow(View view);
//
//        /**
//         * Called when a view is detached from com.kayo.mutiadapter.recyclerview.RecyclerView.
//         *
//         * @param view The View which is being detached from the com.kayo.mutiadapter.recyclerview.RecyclerView
//         */
//        public void onChildViewDetachedFromWindow(View view);
//    }
//
//    /**
//     * A ViewHolder describes an item view and metadata about its place within the com.kayo.mutiadapter.recyclerview.RecyclerView.
//     *
...
//     * to <code>ViewHolder</code> objects and that <code>com.kayo.mutiadapter.recyclerview.RecyclerView</code> instances may hold
...
//         * the end of the layout pass and then recycled by com.kayo.mutiadapter.recyclerview.RecyclerView if it is not added back to
//         * the com.kayo.mutiadapter.recyclerview.RecyclerView.
//         */
...
//         * <p>
//         * This position is mostly used by com.kayo.mutiadapter.recyclerview.RecyclerView components to be consistent while
//         * com.kayo.mutiadapter.recyclerview.RecyclerView lazily processes adapter updates.
//         * <p>
//         * For performance and animation reasons, com.kayo.mutiadapter.recyclerview.RecyclerView batches all adapter updates until the
...
//         * <p>
//         * com.kayo.mutiadapter.recyclerview.RecyclerView does not handle any adapter updates until the next layout traversal. This
...
//
//        /**
//         * When LayoutManager supports animations, com.kayo.mutiadapter.recyclerview.RecyclerView tracks 3 positions for ViewHolders
...
//
//        /**
//         * @return True if ViewHolder is not referenced by com.kayo.mutiadapter.recyclerview.RecyclerView animations but has
...
//         *
//         * <p>Note that if com.kayo.mutiadapter.recyclerview.RecyclerView finds the target view, it will automatically stop the
...
//
//        /**
//         * <p>com.kayo.mutiadapter.recyclerview.RecyclerView will call this method each time it scrolls until it can find the target
...
//    }
//    /**
//     * <p>Contains useful information about the current com.kayo.mutiadapter.recyclerview.RecyclerView state like target scroll
//     * position or view focus. State object can also keep arbitrary data, identified by resource
//     * ids.</p>
//     * <p>Often times, com.kayo.mutiadapter.recyclerview.RecyclerView components will need to pass information between each other.
//     * To provide a well defined data bus between components, com.kayo.mutiadapter.recyclerview.RecyclerView passes the same State
...
//
//        /**
//         * Returns true if the com.kayo.mutiadapter.recyclerview.RecyclerView is currently measuring the layout. This value is
//         * {@code true} only if the LayoutManager opted into the auto measure API and com.kayo.mutiadapter.recyclerview.RecyclerView
//         * has non-exact measurement specs.
//         * <p>
//         * Note that if the LayoutManager supports predictive animations and it is calculating the
//         * pre-layout step, this value will be {@code false} even if the com.kayo.mutiadapter.recyclerview.RecyclerView is in
//         * {@code onMeasure} call. This is because pre-layout means the previous state of the
//         * com.kayo.mutiadapter.recyclerview.RecyclerView and measurements made for that state cannot change the com.kayo.mutiadapter.recyclerview.RecyclerView's size.
...
//         *
//         * @return True if the com.kayo.mutiadapter.recyclerview.RecyclerView is currently calculating its bounds, false otherwise.
//         */
...
//
//        /**
//         * Returns whether com.kayo.mutiadapter.recyclerview.RecyclerView will run predictive animations in this layout pass
//         * or not.
//         *
//         * @return true if com.kayo.mutiadapter.recyclerview.RecyclerView is calculating predictive animations to be run at the end
//         *         of the layout pass.
//         */
...
//
//        /**
//         * Returns whether com.kayo.mutiadapter.recyclerview.RecyclerView will run simple animations in this layout pass
//         * or not.
//         *
//         * @return true if com.kayo.mutiadapter.recyclerview.RecyclerView is calculating simple animations to be run at the end of
//         *         the layout pass.
//         */
...
//         * <p>
//         * com.kayo.mutiadapter.recyclerview.RecyclerView listens for Adapter's notify events and calculates the effects of adapter
//         * data changes on existing Views. These calculations are used to decide which animations
//         * should be run.
//         * <p>
//         * To support predictive animations, com.kayo.mutiadapter.recyclerview.RecyclerView may rewrite or reorder Adapter changes to
...
//         * scenes, com.kayo.mutiadapter.recyclerview.RecyclerView offsets {@link Recycler#getViewForPosition(int)} calls such that
...
//     * ViewHolder items. The com.kayo.mutiadapter.recyclerview.RecyclerView will manage retaining these items while they
...
//     *
//     * <p>By default, com.kayo.mutiadapter.recyclerview.RecyclerView uses {@link DefaultItemAnimator}.</p>
//     *
...
//
//        /**
//         * Called by the com.kayo.mutiadapter.recyclerview.RecyclerView before the layout begins. Item animator should record
...
//         *
//         * @param state       The current State of com.kayo.mutiadapter.recyclerview.RecyclerView which includes some useful data
...
//
//        /**
//         * Called by the com.kayo.mutiadapter.recyclerview.RecyclerView after the layout is complete. Item animator should record
...
//         * the View.
//         *
//         * @param state      The current State of com.kayo.mutiadapter.recyclerview.RecyclerView which includes some useful data about
...
//         * com.kayo.mutiadapter.recyclerview.RecyclerView decides how items should be animated.
//         *
//         * @see #recordPreLayoutInformation(State, ViewHolder, int, List)
//         * @see #animateAppearance(ViewHolder, ItemHolderInfo, ItemHolderInfo)
//         * @see #animateDisappearance(ViewHolder, ItemHolderInfo, ItemHolderInfo)
...
//
//        /**
//         * Called by the com.kayo.mutiadapter.recyclerview.RecyclerView when a ViewHolder has disappeared from the layout.
//         * <p>
...
//         * animation callback method which will be called by the com.kayo.mutiadapter.recyclerview.RecyclerView depends on the
...
//         * ViewHolder or not. com.kayo.mutiadapter.recyclerview.RecyclerView will call
//         * {@link #animateChange(ViewHolder, ViewHolder, ItemHolderInfo, ItemHolderInfo)
...
//         * com.kayo.mutiadapter.recyclerview.RecyclerView will call {@link #recordPostLayoutInformation(State, ViewHolder)} and the
...
//
//        /**
//         * Called by the com.kayo.mutiadapter.recyclerview.RecyclerView when a ViewHolder is added to the layout.
//         * <p>
...
//
//        /**
//         * Called by the com.kayo.mutiadapter.recyclerview.RecyclerView when a ViewHolder is present in both before and after the
//         * layout and com.kayo.mutiadapter.recyclerview.RecyclerView has not received a {@link Adapter#notifyItemChanged(int)} call
...
//         * <p>
//         * If the Item's layout position didn't change, com.kayo.mutiadapter.recyclerview.RecyclerView still calls this method because
...
//
//        /**
//         * Called by the com.kayo.mutiadapter.recyclerview.RecyclerView when an adapter item is present both before and after the
//         * layout and com.kayo.mutiadapter.recyclerview.RecyclerView has received a {@link Adapter#notifyItemChanged(int)} call
//         * for it. This method may also be called when
//         * {@link Adapter#notifyDataSetChanged()} is called and adapter has stable ids so that
//         * com.kayo.mutiadapter.recyclerview.RecyclerView could still rebind views to the same ViewHolders. If viewType changes when
...
//         * <p>
//         * When an item is updated, ItemAnimator has a chance to ask com.kayo.mutiadapter.recyclerview.RecyclerView to keep the
...
//         * to the LayoutManager but com.kayo.mutiadapter.recyclerview.RecyclerView keeps old ViewHolder attached for animations.
//         * <p>
...
//         * {@link #animateDisappearance(ViewHolder, ItemHolderInfo, ItemHolderInfo)
//         * animateDisappearance()}, which inform the com.kayo.mutiadapter.recyclerview.RecyclerView that the ItemAnimator wants to be
...
//         * <p>
//         * For each call com.kayo.mutiadapter.recyclerview.RecyclerView makes to
//         * {@link #animateAppearance(ViewHolder, ItemHolderInfo, ItemHolderInfo)
//         * animateAppearance()},
//         * {@link #animatePersistence(ViewHolder, ItemHolderInfo, ItemHolderInfo)
...
//         * the same ViewHolder for animations or com.kayo.mutiadapter.recyclerview.RecyclerView should create a copy of the
...
//         *
//         * @return True if com.kayo.mutiadapter.recyclerview.RecyclerView should just rebind to the same ViewHolder or false if
//         *         com.kayo.mutiadapter.recyclerview.RecyclerView should create a new ViewHolder and pass this ViewHolder to the
...
//
//    /**
//     * A callback interface that can be used to alter the drawing order of com.kayo.mutiadapter.recyclerview.RecyclerView children.
//     * <p>
